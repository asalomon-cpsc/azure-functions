...
static IEnumerable<State> RunPoller(TraceWriter log, StateEntity url)
{
    ...
    catch (System.AggregateException ex)
    {
        ...
        {
            Status = "000",
            Description = $"- {e.ToString()} - This may be a transient, a temporary error that is likely to disappear soon. You can view the dashboard and re-initiate the polling by clicking on the refresh button to be sure.",
            UrlName = url.UrlName,
            Url = url.Url
        };
